...
require (
	...
	github.com/nspcc-dev/neofs-sdk-go v1.0.0-rc.11.0.20240326074255-eca65c850297
...
require (
	...
	github.com/nspcc-dev/neofs-api-go/v2 v2.14.1-0.20240228163253-cb87bbd5e4eb // indirect
